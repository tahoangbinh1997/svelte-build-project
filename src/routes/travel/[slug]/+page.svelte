		...
		<div class="row d-flex">
			<div class="col-lg-8 px-md-5 py-5" data-aos="fade-up">
				<div class="row pt-md-4">
					...
					<p>
						<!-- svelte-ignore a11y-img-redundant-alt -->
						<img src="images/ximage_2.jpg.pagespeed.ic.hn6JeducHP.jpg" alt="" class="img-fluid" />
					</p>
					<p>
					...
					<p>
						Odit voluptatibus, eveniet vel nihil cum ullam dolores laborum, quo velit commodi rerum
